...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p ca7cb8e9-8d3a-4ceb-8551-d5b1d4d9e243
```

> `ca7cb8e9-8d3a-4ceb-8551-d5b1d4d9e243` is the password of the certificate, you can change it to any password you want.
